...
int main(int argc,char *argv[]){
	...
	//for now to avoid segementation error intilize entire hashtable structs
	for( i=0;i<10000;i++){
		struct List temp;
		temp.data= 2147483647;
		temp.empty =0;
		temp.next = NULL;
		hashTable[i] = temp;
	}
	...
	//take searching and  inserting at negative indices, switch to positive
